...
import { gbp, keywords, num, opportunities, siteSearches, store } from "@/lib/data";
...
export default function DemandPage() {
  ...
  return (
    <Shell
      title="Demand Radar"
      subtitle={`Market and first-party intent · providers: Search Console, DataForSEO, site search · sector mode: ${store.sectorMode}`}
      actions={
        <>
