...
const Body = z.object({
  ...
  smsConsentLabel: z.string().max(200).optional(),
  whatsappConsentLabel: z.string().max(200).optional(),
...
export async function POST(req: NextRequest) {
  ...
  const form = await db.form.create({
    data: {
      ...
      smsConsentLabel: d.smsConsentLabel,
      whatsappConsentLabel: d.whatsappConsentLabel,
