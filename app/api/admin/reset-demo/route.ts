...
export async function POST(req: NextRequest) {
  ...
  const tables = [
    ...
    db.consentRecord, db.contactSource, db.importRow, db.importBatch,
  ...
  if (ws) await audit(ws.id, actor, "admin.demo_reset", "Workspace wiped and re-seeded (staging demo reset)");
