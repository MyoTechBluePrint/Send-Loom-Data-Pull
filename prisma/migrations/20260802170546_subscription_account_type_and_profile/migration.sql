...
CREATE TABLE "new_Subscription" (
    ...
    "businessType" TEXT,
    "expectedContacts" INTEGER,
    "expectedSends" INTEGER,
    "expectedSites" INTEGER,
    "primaryGoal" TEXT,
    "websiteUrl" TEXT,
    ...
    "accountType" TEXT NOT NULL DEFAULT 'external',
